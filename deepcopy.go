...
//
// Copyright 2015 www.jd.com
//
// File: /home/xuriwuyun/go/deepcopy.go
// Author: xuriwuyun <xuriwuyun@gmail.com>
// Created: 05/06/2015 14:40:45
// Last_modified: 05/13/2015 11:28:18
...
func ExportChanges(dir string, changes []Change) (archive.Archive, error) {
...
func main() {
	//root, err := collectFileInfo("/home/xuriwuyun")
	changes, err := ChangesDirs("/home/xuriwuyun/", "/media/xuriwuyun/新加卷1/home/")
	if err != nil {
		fmt.Println(err)
	}
	for _, change := range changes {
	...
	arch, err := ExportChanges("/home/xuriwuyun/", changes)
	if err != nil {
		return
	}

	diff := ioutils.NewReadCloserWrapper(arch, func() error {
		err := arch.Close()
		return err
	})

	if _, err := archive.UnpackLayer("/media/xuriwuyun/新加卷1/home", diff); err != nil {
		fmt.Println(err)
	}
